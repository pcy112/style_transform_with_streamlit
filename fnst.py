...
class Learner():
    ...
    def save_tfm_net(self, e, i):
        ...
        path = os.path.join('tmp', 'models', name)
        torch.save(self.tfm_net.state_dict(), path)
        return path
...
def train_learner(style_image, im_size, epochs):
    ...
    lrn = Learner(loss_network=loss_network,
                    ...
                    check_image=CHECK_IMAGE, im_size=im_size,
...
def main():
    ...
    parser.add_argument('--style_path', dest='style_path', type=str, default='images/style/candy.jpg')
    parser.add_argument('--img_size', dest='img_size', type=int, default=128)
    parser.add_argument('--model_path', dest='model_path', type=str, default='models/candy.pth')
    parser.add_argument('--input_path', dest='input_path', type=str, default='tmp/input.jpg')
    parser.add_argument('--output_path', dest='output_path', type=str, default='images/sample')
